      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 25,),
            Text('الحمار الوحشي', style: TextStyle(
                color: Colors.black, fontWeight: FontWeight.bold, fontSize: 35, fontFamily: 'Nunito'
            ),),
            SizedBox(height: 10,),
            Text('تلد أمهات الحمار الوحشي \n              مهرا واحد.', style: TextStyle(
            ...
            SizedBox(height: 25,),
            Text(
              'يصدر حمار وحشي صوت شخير.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text('الحمير الوحشية حيوانات أحادية الظلف \n التي هي موطنها أفريقيا.', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text(" كل نوع من أنواع الحمار الوحشي لديه\n نمط عام مختلف من المشارب.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('الميزة الأبرز \n الحمر الوحشية هي الأنماط الجريئة \n على معاطفهم. ', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
