                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          SizedBox(width: 43),
                          Text('تعلم الرسم' , style: TextStyle(color: Colors.white, fontFamily: 'LoveYaLikeASister', fontSize: 46),),
                        ],
                      ),
                      Image(
                          height: 200,
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 38),
                    Text('الأشكال',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 34),),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 35),
                    Text('خربشة',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 32),),
                  ],
                ),
              ),
            ),
