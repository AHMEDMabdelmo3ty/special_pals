      ...
      body:  SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 25,),
            Text('حرباء', style: TextStyle(
                color: Colors.black, fontWeight: FontWeight.bold, fontSize: 35, fontFamily: 'Nunito'
            ),),
            SizedBox(height: 10,),
            Text('تلد أمهات الحرباء \n    ثمانية إلى ثلاثين شابًا.', style: TextStyle(
            ...
            SizedBox(height: 25,),
            Text(
              'الحرباء لا تصدر أي صوت.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text("الحرباء هي الزواحف التي هي \n جزء من رتيبة الإغوانا.", style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text("هذه السحالي الملونة معروفة \n كواحد من الحيوانات القليلة التي \n يمكن أن يغير لون البشرة.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('أيديهم وأقدامهم كبيرة \n أصابع القدم التي تساعدهم على التشبث \n الفروع.', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
