            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    SizedBox(width: 60),
                    Text('الحمار الوحشي', style: TextStyle(fontFamily: 'Nunito', color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold,),),
                    SizedBox(width: 75),
                    Text('الزرافه', style: TextStyle(fontFamily: 'Nunito', color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold,),),
                  ],
                ),
              ],
            ),
