      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 25,),
            Text(
              'الزرافة تصدر صوت ثغاء.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text('الزرافات هي الأطول \n الثدييات على الأرض.', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text("يمكنهم الركض بسرعة تصل إلى 35 ميلاً \n ساعة لمسافات قصيرة.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text("رقبة الزرافة قصيرة جدًا \n للوصول إلى الأرض.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
