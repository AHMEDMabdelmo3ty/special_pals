                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            SizedBox(width: 114),
                            Text('الألغاز' , style: TextStyle(color: Colors.white, fontFamily: 'LoveYaLikeASister', fontSize: 46),),
                          ],
                        ),
                        Image(
                            height: 200,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 42),
                      Text('المباراة',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 32),),
                    ],
                  ),
                ),
              ),
