      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              SizedBox(height: 14,),
              Text('اضغط علينا لمعرفة المزيد.', style: TextStyle(
              ...
              Row(
                children: <Widget>[
                  SizedBox(width: 46),
                  Text('أرماديلو', style: TextStyle(fontFamily: 'Nunito', color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold,),),
                  SizedBox(width: 75),
                  Text('انتقد -->', style: TextStyle(fontFamily: 'Nunito', color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold,),),
                ],
              ),
            ],
          ),
