                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          SizedBox(width: 124),
                          Text('القصص' , style: TextStyle(color: Colors.white, fontFamily: 'LoveYaLikeASister', fontSize: 46),),
                        ],
                      ),
                      Image(
                          height: 180,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 15),
                      Text('قصة القارب',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 28),),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 30),
                      Text('قصة المرأب',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 28),),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 20),
                      Text('قصة المراعي',style: TextStyle(color: Colors.white,fontFamily: 'LoveYaLikeASister', fontSize: 28),),
                    ],
                  ),
                ),
              ),
