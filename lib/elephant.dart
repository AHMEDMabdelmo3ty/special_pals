      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 25,),
            Text(
              'الفيل يصدر صوت البوق.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text('الفيلة هي العالم\nأكبر حيوان بري!', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('الأفيال الأفريقية لها آذان كبيرة \n على شكل قارة إفريقيا!', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text(' الفيل الأفريقي والآسيوي \n الفيل نوعان من \n أنواع الفيل.', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
